<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="comment.*"%>
<%
	...
	<div id="post" style="margin-top: 60px;">
		...
		<FORM ACTION=".\Controller" method="Post">
			<Fieldset class="discussionbox">
				...
				<label for="contentBox"></label> <textarea name="content"
					id="contentBox" class="transition"></textarea>
				<%-- <textarea name="content" id="contentBox"   rows="10" cols="80" ></textarea>--%>
				<%--class="transition" --%>
				<div>
					<%--<input type="hidden" name="contentBox1" value="${DisplayBoard.pdesc}" > --%>
