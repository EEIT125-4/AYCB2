...
<div style="position: relative;top: 200px;left: 30px;width: 150px;">
	<% MemberBean member=(MemberBean)session.getAttribute("login_session"); %>
	 ...
	 <span style="border-bottom: 2px solid gray;width: 150px;"><strong><%=member.getName()+"       " %>  您好!</strong></span><br>

	 	 
	  
	  <A style="color:black;" href="./historyOrders.jsp"><h3>查詢歷史清單</h3></A>
</div>  


	 
	<fieldset style="float:auto;">
	<h3><strong>您購物車中的商品</strong><h3>
      <%
      ...
      <form id="butt" name=".\shoppingForm" action="ControllerServlet" method="POST">
      ...
      <%
      response.setHeader("Refresh","2;ShowAll.jsp");
      }        
      %>
