...
<div style="position: relative; top: 200px;">
	...
	<form action=".\EventServlet" method="post">
		<fieldset>
			...
			<div class="form1">
				<label for="ma1" class="label1">更改email:</label> <input type="email"
			...
			<div class="form1">
				<label for="" class="label1">更改參加活動日期</label> <input type="date"
					name="eventdate">
			</div>
			<div class="sub">
				<input type="submit" name="modify" value="更改報名資料" ">
			</div>
		</fieldset>
	</form>
</div>
