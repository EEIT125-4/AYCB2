    ...
    <h2>留言內容如下:</h2>
     ...
     <table >
      <tr>
       ...
       <td><jsp:getProperty name="dis_board" property="name" /></td>
      </tr>
      <tr >
       <td>性別:</td>
       <td><jsp:getProperty name="dis_board" property="gender" /></td>
      </tr>
      <tr >
       <td>年齡:</td>
       <td><jsp:getProperty name="dis_board" property="age" /></td>
      </tr>
      <tr>
       <td>留言內容:</td>
       <td><jsp:getProperty name="dis_board" property="contentBox" /></td>
      </tr>
      <tr>
       <td>留言日期:</td>
       <td><jsp:getProperty name="dis_board" property="commentTime" />
       </td>
      </tr>
