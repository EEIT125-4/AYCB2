	...
	<fieldset
		...
		<form action="RegisterServlet" method="post">
			<table>
				...
				<tr>
					<td>*性別</td>
					<td><input type="radio" name="gender" value="男">先生
						<input type="radio" name="gender" value="女">小姐</td>
				</tr>
				<tr>
					<td>*帳號</td>
					<td><input class="ddd" type="text" name="acc" id="acc"></td>
				</tr>
				<tr>
					<td>*密碼</td>
				...
				<tr>
					<td>*生日</td>
					<td><div>
							<select class="bb" name="byear" id="byear">
							...
							</select> <select class="bb" name="bmonth" id="bmonth">
								<option value="">請選擇</option>
							...
							</select> <select class="bb" name="bday" id="bday">
								<option value="">請選擇</option>
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
